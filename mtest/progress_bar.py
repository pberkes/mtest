# Progress bar utilities courtesy of Tiziano Zito
# Copyright (c) 2003-2011 Tiziano Zito

# Although it's a bit excessive to include this large file in order to get
# a progress bar, building the tables can take hours, and I felt like
# an estimate of the finish time was necessary
...
def get_termsize():
    ...
    try:
        ...
        # for windows machines, use default values
